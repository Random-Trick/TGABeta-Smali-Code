...
.method private static parseBirthDate(Ljava/lang/String;Lorg/telegram/messenger/MrzRecognizer$Result;)V
    ...
    :try_end_3b
    .catch Ljava/lang/NumberFormatException; {:try_start_2 .. :try_end_3b} :catch_3b
...
.method private static parseExpiryDate(Ljava/lang/String;Lorg/telegram/messenger/MrzRecognizer$Result;)V
    ...
    :try_end_2f
    .catch Ljava/lang/NumberFormatException; {:try_start_0 .. :try_end_2f} :catch_2f
...
.method private static recognizeBarcode(Landroid/graphics/Bitmap;)Lorg/telegram/messenger/MrzRecognizer$Result;
    ...
    :try_end_172
    .catch Ljava/lang/NumberFormatException; {:try_start_f8 .. :try_end_172} :catch_172
    ...
    :try_end_21d
    .catch Ljava/lang/Exception; {:try_start_186 .. :try_end_21d} :catch_21e
...
.method private static recognizeMRZ(Landroid/graphics/Bitmap;)Lorg/telegram/messenger/MrzRecognizer$Result;
    ...
    if-lt v13, v7, :cond_26c

    if-lt v12, v14, :cond_26c
    ...
    :goto_272
    if-lt v12, v14, :cond_77f

    if-ge v13, v7, :cond_278
    ...
    :cond_4d7
    if-eq v4, v8, :cond_4e4

    const/16 v13, 0x41

    if-eq v4, v13, :cond_4e4

    const/16 v13, 0x43

    if-ne v4, v13, :cond_4e2
