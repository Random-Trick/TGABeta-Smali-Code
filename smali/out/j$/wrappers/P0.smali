...
.method private synthetic constructor <init>(Ljava/util/stream/LongStream;)V
    ...
    iput-object p1, p0, Lj$/wrappers/P0;->a:Ljava/util/stream/LongStream;

    return-void
.end method

.method public static synthetic n0(Ljava/util/stream/LongStream;)Lj$/util/stream/f1;
    .registers 2
    ...
    iget-object p0, p0, Lj$/wrappers/Q0;->a:Lj$/util/stream/f1;
    ...
    invoke-direct {v0, p0}, Lj$/wrappers/P0;-><init>(Ljava/util/stream/LongStream;)V
...
.method public synthetic D(JLj$/util/function/o;)J
    ...
    iget-object v0, p0, Lj$/wrappers/P0;->a:Ljava/util/stream/LongStream;

    invoke-static {p3}, Lj$/wrappers/e0;->a(Lj$/util/function/o;)Ljava/util/function/LongBinaryOperator;
...
.method public synthetic L(Lj$/wrappers/j0;)Z
    .registers 3

    iget-object v0, p0, Lj$/wrappers/P0;->a:Ljava/util/stream/LongStream;

    invoke-static {p1}, Lj$/wrappers/k0;->a(Lj$/wrappers/j0;)Ljava/util/function/LongPredicate;
...
.method public synthetic O(Lj$/wrappers/l0;)Lj$/util/stream/U;
    .registers 3
    ...
    .line 1
    :cond_6
    iget-object p1, p1, Lj$/wrappers/l0;->a:Ljava/util/function/LongToDoubleFunction;
...
.method public synthetic Q(Lj$/util/function/r;)Lj$/util/stream/Stream;
    ...
    invoke-static {p1}, Lj$/wrappers/i0;->a(Lj$/util/function/r;)Ljava/util/function/LongFunction;
...
.method public synthetic S(Lj$/wrappers/j0;)Z
    .registers 3
...
.method public synthetic distinct()Lj$/util/stream/f1;
    .registers 2
...
.method public synthetic e0(Lj$/wrappers/n0;)Lj$/util/stream/M0;
    .registers 3
    ...
    .line 1
    :cond_6
    iget-object p1, p1, Lj$/wrappers/n0;->a:Ljava/util/function/LongToIntFunction;
...
.method public synthetic f0(Lj$/util/function/y;Lj$/util/function/w;Lj$/util/function/BiConsumer;)Ljava/lang/Object;
    ...
    invoke-static {p2}, Lj$/wrappers/w0;->a(Lj$/util/function/w;)Ljava/util/function/ObjLongConsumer;
...
.method public synthetic findAny()Lj$/util/l;
    ...
    invoke-static {v0}, Lj$/util/a;->s(Ljava/util/OptionalLong;)Lj$/util/l;
...
.method public synthetic g(Lj$/util/function/o;)Lj$/util/l;
    ...
    invoke-static {p1}, Lj$/wrappers/e0;->a(Lj$/util/function/o;)Ljava/util/function/LongBinaryOperator;
    ...
    invoke-static {p1}, Lj$/util/a;->s(Ljava/util/OptionalLong;)Lj$/util/l;
...
.method public synthetic k(Lj$/wrappers/j0;)Z
    .registers 3
...
.method public synthetic limit(J)Lj$/util/stream/f1;
    .registers 4
...
.method public synthetic p(Lj$/util/function/q;)Lj$/util/stream/f1;
    .registers 3
...
.method public synthetic parallel()Lj$/util/stream/f1;
    .registers 2
...
.method public synthetic s(Lj$/util/function/r;)Lj$/util/stream/f1;
    .registers 3
...
.method public synthetic sequential()Lj$/util/stream/f1;
    .registers 2
...
.method public synthetic skip(J)Lj$/util/stream/f1;
    .registers 4
...
.method public synthetic sorted()Lj$/util/stream/f1;
    .registers 2
...
.method public synthetic spliterator()Lj$/util/w;
    .registers 2
...
.method public synthetic u(Lj$/wrappers/j0;)Lj$/util/stream/f1;
    .registers 3
...
.method public synthetic z(Lj$/util/function/t;)Lj$/util/stream/f1;
    .registers 3
