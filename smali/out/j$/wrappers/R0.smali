...
.method private synthetic constructor <init>(Lj$/util/stream/Stream;)V
    ...
    iput-object p1, p0, Lj$/wrappers/R0;->a:Lj$/util/stream/Stream;
...
.method public static synthetic n0(Lj$/util/stream/Stream;)Ljava/util/stream/Stream;
    ...
    invoke-direct {v0, p0}, Lj$/wrappers/R0;-><init>(Lj$/util/stream/Stream;)V
...
.method public synthetic allMatch(Ljava/util/function/Predicate;)Z
    ...
    iget-object v0, p0, Lj$/wrappers/R0;->a:Lj$/util/stream/Stream;
...
.method public synthetic collect(Ljava/util/stream/Collector;)Ljava/lang/Object;
    ...
    invoke-static {p1}, Lj$/wrappers/J0;->d(Ljava/util/stream/Collector;)Lj$/wrappers/J0;

    move-result-object p1

    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->b0(Lj$/wrappers/J0;)Ljava/lang/Object;
...
.method public synthetic findAny()Ljava/util/Optional;
    ...
    invoke-static {v0}, Lj$/util/a;->t(Lj$/util/Optional;)Ljava/util/Optional;
...
.method public synthetic flatMapToInt(Ljava/util/function/Function;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->c(Lj$/util/function/Function;)Lj$/util/stream/M0;
...
.method public synthetic flatMapToLong(Ljava/util/function/Function;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->X(Lj$/util/function/Function;)Lj$/util/stream/f1;
...
.method public synthetic mapToDouble(Ljava/util/function/ToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->j0(Lj$/util/function/z;)Lj$/util/stream/U;
...
.method public synthetic mapToInt(Ljava/util/function/ToIntFunction;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->m(Lj$/util/function/ToIntFunction;)Lj$/util/stream/M0;
...
.method public synthetic mapToLong(Ljava/util/function/ToLongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->g0(Lj$/util/function/A;)Lj$/util/stream/f1;
...
.method public synthetic max(Ljava/util/Comparator;)Ljava/util/Optional;
    ...
    invoke-static {p1}, Lj$/util/a;->t(Lj$/util/Optional;)Ljava/util/Optional;
