...
.method constructor <init>(Lj$/util/stream/c;I)V
    ...
    invoke-static {p2, v1}, Lj$/util/stream/e4;->a(II)I
...
.method constructor <init>(Lj$/util/y;IZ)V
    ...
    iput-object p1, p0, Lj$/util/stream/c;->g:Lj$/util/y;

    iput-object p0, p0, Lj$/util/stream/c;->a:Lj$/util/stream/c;

    sget p1, Lj$/util/stream/e4;->g:I
...
.method private I0(I)Lj$/util/y;
    .registers 9

    iget-object v0, p0, Lj$/util/stream/c;->a:Lj$/util/stream/c;

    iget-object v1, v0, Lj$/util/stream/c;->g:Lj$/util/y;

    if-eqz v1, :cond_66

    const/4 v2, 0x0

    iput-object v2, v0, Lj$/util/stream/c;->g:Lj$/util/y;
    ...
    invoke-virtual {v5, v4}, Lj$/util/stream/e4;->d(I)Z

    move-result v5

    if-eqz v5, :cond_2c

    sget v5, Lj$/util/stream/e4;->u:I
    ...
    :cond_2c
    invoke-virtual {v2, v0, v1}, Lj$/util/stream/c;->F0(Lj$/util/stream/z2;Lj$/util/y;)Lj$/util/y;

    move-result-object v1

    const/16 v5, 0x40

    invoke-interface {v1, v5}, Lj$/util/y;->hasCharacteristics(I)Z

    move-result v5

    if-eqz v5, :cond_40

    sget v5, Lj$/util/stream/e4;->t:I

    xor-int/lit8 v5, v5, -0x1

    and-int/2addr v4, v5

    sget v5, Lj$/util/stream/e4;->s:I
    ...
    invoke-static {v4, v0}, Lj$/util/stream/e4;->a(II)I
    ...
    invoke-static {p1, v0}, Lj$/util/stream/e4;->a(II)I
...
# virtual methods
.method abstract A0(Lj$/util/y;Lj$/util/stream/n3;)V
.end method

.method abstract B0()Lj$/util/stream/f4;
.end method
...
.method public synthetic D0()Lj$/util/y;
    .registers 2

    const/4 v0, 0x0

    invoke-direct {p0, v0}, Lj$/util/stream/c;->I0(I)Lj$/util/y;
...
.method F0(Lj$/util/stream/z2;Lj$/util/y;)Lj$/util/y;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lj$/util/stream/c;->E0(Lj$/util/stream/z2;Lj$/util/y;Lj$/util/function/m;)Lj$/util/stream/B1;

    move-result-object p1

    invoke-interface {p1}, Lj$/util/stream/B1;->spliterator()Lj$/util/y;
...
.method abstract H0(ILj$/util/stream/n3;)Lj$/util/stream/n3;
.end method

.method final J0()Lj$/util/y;
    .registers 4
...
.method abstract K0(Lj$/util/stream/z2;Lj$/util/function/y;Z)Lj$/util/y;
.end method
...
.method public close()V
    ...
    iput-object v0, p0, Lj$/util/stream/c;->g:Lj$/util/y;
...
.method final n0(Lj$/util/stream/n3;Lj$/util/y;)V
    .registers 5

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v0, Lj$/util/stream/e4;->SHORT_CIRCUIT:Lj$/util/stream/e4;
    ...
    invoke-interface {p2}, Lj$/util/y;->getExactSizeIfKnown()J

    move-result-wide v0

    invoke-interface {p1, v0, v1}, Lj$/util/stream/n3;->n(J)V

    invoke-interface {p2, p1}, Lj$/util/y;->forEachRemaining(Lj$/util/function/Consumer;)V

    invoke-interface {p1}, Lj$/util/stream/n3;->m()V

    goto :goto_1e

    :cond_1b
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/c;->o0(Lj$/util/stream/n3;Lj$/util/y;)V

    :goto_1e
    return-void
.end method

.method final o0(Lj$/util/stream/n3;Lj$/util/y;)V
    .registers 6
    ...
    invoke-virtual {v0, p2, p1}, Lj$/util/stream/c;->A0(Lj$/util/y;Lj$/util/stream/n3;)V
...
.method final p0(Lj$/util/y;ZLj$/util/function/m;)Lj$/util/stream/B1;
    .registers 6
    ...
    .line 2
    invoke-virtual {p0, p0, p1, p2, p3}, Lj$/util/stream/c;->z0(Lj$/util/stream/z2;Lj$/util/y;ZLj$/util/function/m;)Lj$/util/stream/B1;
    ...
    :cond_b
    invoke-virtual {p0, p1}, Lj$/util/stream/c;->q0(Lj$/util/y;)J

    move-result-wide v0

    invoke-virtual {p0, v0, v1, p3}, Lj$/util/stream/z2;->t0(JLj$/util/function/m;)Lj$/util/stream/t1;
    ...
    invoke-virtual {p0, p2}, Lj$/util/stream/c;->v0(Lj$/util/stream/n3;)Lj$/util/stream/n3;

    move-result-object p3

    invoke-virtual {p0, p3, p1}, Lj$/util/stream/c;->n0(Lj$/util/stream/n3;Lj$/util/y;)V
...
.method final q0(Lj$/util/y;)J
    ...
    invoke-interface {p1}, Lj$/util/y;->getExactSizeIfKnown()J
...
.method final r0()Lj$/util/stream/f4;
    .registers 3
...
.method public spliterator()Lj$/util/y;
    ...
    .line 2
    invoke-virtual {p0, p0, v1, v0}, Lj$/util/stream/c;->K0(Lj$/util/stream/z2;Lj$/util/function/y;Z)Lj$/util/y;
...
.method final u0(Lj$/util/stream/n3;Lj$/util/y;)Lj$/util/stream/n3;
    .registers 4

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-virtual {p0, p1}, Lj$/util/stream/c;->v0(Lj$/util/stream/n3;)Lj$/util/stream/n3;

    move-result-object v0

    invoke-virtual {p0, v0, p2}, Lj$/util/stream/c;->n0(Lj$/util/stream/n3;Lj$/util/y;)V

    return-object p1
.end method

.method final v0(Lj$/util/stream/n3;)Lj$/util/stream/n3;
    .registers 4
    ...
    invoke-virtual {v0, v1, p1}, Lj$/util/stream/c;->H0(ILj$/util/stream/n3;)Lj$/util/stream/n3;
...
.method final w0(Lj$/util/y;)Lj$/util/y;
    .registers 3
    ...
    invoke-direct {v0, p1}, Lj$/util/stream/b;-><init>(Lj$/util/y;)V
    ...
    .line 2
    invoke-virtual {p0, p0, v0, p1}, Lj$/util/stream/c;->K0(Lj$/util/stream/z2;Lj$/util/function/y;Z)Lj$/util/y;
...
.method final x0(Lj$/util/stream/O4;)Ljava/lang/Object;
    .registers 3
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/O4;->c(Lj$/util/stream/z2;Lj$/util/y;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/O4;->d(Lj$/util/stream/z2;Lj$/util/y;)Ljava/lang/Object;
...
.method final y0(Lj$/util/function/m;)Lj$/util/stream/B1;
    .registers 5
    ...
    invoke-direct {v0, v2}, Lj$/util/stream/c;->I0(I)Lj$/util/y;

    move-result-object v1

    invoke-virtual {p0, v0, v1, p1}, Lj$/util/stream/c;->E0(Lj$/util/stream/z2;Lj$/util/y;Lj$/util/function/m;)Lj$/util/stream/B1;
    ...
    :cond_25
    invoke-direct {p0, v2}, Lj$/util/stream/c;->I0(I)Lj$/util/y;

    move-result-object v1

    invoke-virtual {p0, v1, v0, p1}, Lj$/util/stream/c;->p0(Lj$/util/y;ZLj$/util/function/m;)Lj$/util/stream/B1;
...
.method abstract z0(Lj$/util/stream/z2;Lj$/util/y;ZLj$/util/function/m;)Lj$/util/stream/B1;
.end method
